...
namespace Prwirepro_press_release_template\Inc\Admin;
...
class Admin {
	...
	public function add_plugin_admin_menu() {
		...
		add_menu_page(	__( 'Press Release Template', $this->plugin_text_domain ), //page title
						__( 'Press Release Template', $this->plugin_text_domain ), //menu title
		...
		$html_form_page_hook = add_submenu_page( 
									...
									__( 'Press Release Template', $this->plugin_text_domain ), //page title
